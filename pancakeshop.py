class Stack():
    ...
    def pop_two(self):
        """Remove two items from end of stack and return it."""
...
fruits = make_short_stack(["Apple", "Berry", "Cherry", "Durian", "Emu Berry Fruit", "Fig"])
print(fruits)
fruit = fruits.pop()
print(fruit)
print(fruits)
fruit2 = fruits.pop_two()
print(fruit2)
print(fruits)