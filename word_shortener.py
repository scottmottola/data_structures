...
class LinkedList(object):
    ...
    def linked_length(self):
        """Print the amount of items in the list."""
...
def shorten_word2(words):
    lword = LinkedList()
    for word in words:
        lword.append(word)
    lword.remove(words[0])
    return lword


shorten_word(["Apple", "Berry", "Cherry", "Durian", "Emu Berry Fruit", "Fig"]).print_list()
print(shorten_word(["Apple", "Berry", "Cherry", "Durian", "Emu Berry Fruit", "Fig"]).linked_length())
shorten_word2(["Apple", "Berry", "Cherry", "Durian", "Emu Berry Fruit", "Fig"]).print_list()
print(shorten_word2(["Apple", "Berry", "Cherry", "Durian", "Emu Berry Fruit", "Fig"]).linked_length())